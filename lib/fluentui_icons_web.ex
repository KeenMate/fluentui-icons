defmodule FluentuiIconsWeb do
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/fluentui_icons_web/templates",
        namespace: FluentuiIconsWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {FluentuiIconsWeb.LayoutView, :live}
