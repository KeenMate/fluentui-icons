defmodule FluentuiIconsWeb.Router do
  use FluentuiIconsWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {FluentuiIconsWeb.LayoutView, :root}
  ...
  scope "/api", FluentuiIconsWeb.API do
    pipe_through :api
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: FluentuiIconsWeb.Telemetry
    end
  end
